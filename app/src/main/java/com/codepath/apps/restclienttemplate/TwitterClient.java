...
// each method represents an API endpoint!
// defines all endpoints will be accessing in app
public class TwitterClient extends OAuthBaseClient {
	...
	public void getHomeTimeline(AsyncHttpResponseHandler handler) {
		...
		Log.d("deb","requesting");
		params.put("count", 25);
		params.put("since_id", 1);  // pull to refresh, posts greater than 1 on current feed?
	...
	public void getTwitterProfilePicture(AsyncHttpResponseHandler handler){
	...
	public void destroyFavoriteTweet(long tweetId, AsyncHttpResponseHandler handler){
